...
ARTEMIS_DATA_DIR='/opt/artemis/broker/data'
ARTEMIS_ETC_DIR='/opt/artemis/broker/etc'
ARTEMIS_OOME_DUMP='/opt/artemis/broker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/opt/artemis/broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/opt/artemis/broker/etc/'
